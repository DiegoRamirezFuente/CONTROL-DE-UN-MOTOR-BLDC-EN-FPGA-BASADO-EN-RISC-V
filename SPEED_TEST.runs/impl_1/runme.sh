...
HD_PWD='C:/Users/diego/TFG/SPEED_TEST_MEN_FSM_PID/SPEED_TEST.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log direct_control_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source direct_control_top.tcl -notrace
