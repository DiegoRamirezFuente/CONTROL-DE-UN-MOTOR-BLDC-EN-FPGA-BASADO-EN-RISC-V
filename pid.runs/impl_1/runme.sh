...
HD_PWD='C:/Users/diego/TFG/pid/pid.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log pid_gen.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source pid_gen.tcl -notrace
