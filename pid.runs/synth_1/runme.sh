...
HD_PWD='C:/Users/diego/TFG/pid/pid.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log neorv32_test_setup_diego.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source neorv32_test_setup_diego.tcl
