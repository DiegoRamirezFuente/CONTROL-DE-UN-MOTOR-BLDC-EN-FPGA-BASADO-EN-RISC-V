...
HD_PWD='C:/Users/diego/TFG/control_directo/control_directo.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log direct_control_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source direct_control_top.tcl
